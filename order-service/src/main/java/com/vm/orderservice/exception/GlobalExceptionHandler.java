...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInventoryOperationException(
            InventoryOperationException ex,
            HttpServletRequest request) {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, ex.getMessage(), request.getRequestURI());
    }

    @ExceptionHandler(OrderEventPublishException.class)
    public ResponseEntity<ErrorResponse> handleOrderEventPublishException(
            OrderEventPublishException ex,
            HttpServletRequest request) {
